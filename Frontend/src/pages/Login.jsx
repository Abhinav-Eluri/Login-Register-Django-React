...
function Login() {
    ...
    const handleSubmit = async (event) => {
        ...
        console.log("name", details.email, "value", details.password);
        const response = await axios.post("http://localhost:8000/users/login/", details);
    ...
    return (
        <div className="h-screen bg-gradient-to-br from-white to-gray-600 flex flex-col justify-center items-center w-full">
             {
                alert && (
                    <div role="alert"
            ...
            <form onSubmit={handleSubmit}>
                <div className="bg-white px-10 py-8 rounded-xl w-screen shadow-xl max-w-sm">
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center border-2 py-2 px-3 rounded-md mb-4">
                            ...
                            <input className="pl-2 outline-none border-none w-full" type="email" name="email"
                                   placeholder="Email" value={details.email} onChange={handleChange} required/>
                        ...
                        <div className="flex items-center border-2 py-2 px-3 rounded-md">
                            ...
                            <input className="pl-2 outline-none border-none w-full" type="password" name="password"
                                   id="password" value={details.password} placeholder="Password" onChange={handleChange}
                                   required/>
                    ...
                    <div className="flex justify-center items-center mt-4">
                        <p className="inline-flex items-center text-gray-700 font-medium text-xs text-center">
                        <span className="ml-2">You don't have an account?<a href="/register"
                                                                            className="text-xs ml-2 text-blue-500 font-semibold">Register now &rarr;</a>
                        </span>
                        </p>
                    </div>
                </div>
